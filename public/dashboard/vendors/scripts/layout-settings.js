(function() {
	...
	$(document).ready(function() {
		...
		var header_gray = jQuery('.header-gray');

		header_dark.click(function() {
			'use strict';
			jQuery(this).addClass('active');
			header_light.removeClass('active');
			header_gray.removeClass('active');
			body.removeClass('header-white').removeClass('header-gray').addClass('header-dark');
		...
		header_light.click(function() {
			...
			header_gray.removeClass('active');
			body.removeClass('header-dark').removeClass('header-gray').addClass('header-white');
        ...
        header_gray.click(function() {
			'use strict';
			jQuery(this).addClass('active');
			header_dark.removeClass('active');
			header_light.removeClass('active');
			body.removeClass('header-dark').removeClass('header-white').addClass('header-gray');

			//Store in local storage
			setOptions("headerBackground", "header-gray")
		});

		//Click for current options
		if (currentOptions.headerBackground === "header-gray") {
			header_gray.trigger("click")
		}
